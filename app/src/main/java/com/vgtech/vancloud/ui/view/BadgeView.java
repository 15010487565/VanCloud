...
/**
 * A simple text label com.vgtech.personaledition.view that can be applied as a "badge" to any given {@link android.view.View}.
...
public class BadgeView extends TextView {
     ...
     *
     * @param context context for this com.vgtech.personaledition.view.
     ...
     * Make the badge visible in the UI.
     *
     * @param anim Animation to apply to the com.vgtech.personaledition.view when made visible.
     */
     ...
     * Make the badge non-visible in the UI.
     *
     * @param anim Animation to apply to the com.vgtech.personaledition.view when made non-visible.
     */
     ...
     * Toggle the badge visibility in the UI.
     *
     * @param animIn Animation to apply to the com.vgtech.personaledition.view when made visible.
     * @param animOut Animation to apply to the com.vgtech.personaledition.view when made non-visible.
     */
