...
//        listView.setMode(PullToRefreshBase.Mode.BOTH);
    ...
    protected void lazyLoad() {
        ...
        startdate = DataUtils.currentMonthFirstDay() + "";
        enddate = DataUtils.currentMonthLastDay() + "";
    ...
    public void searchRequest(String keyword, String startTime, String endTime) {
        ...
        nextId = "0";
        Log.e("ceshi", "WorkReportMonthlyPaperFragment--月报---keyword------" + keyword
            ...
            if (RECEIVER_DRAFT.equals(action)) {
                ...
                switch (receiverType) {
                    case PublishTask.PUBLISH_COMMENT:
                        ...
                        if (workReportNewActivity.permission.equals("2") && workReportNewActivity.subordinateTypeCurrentTab == 2) {
        ...
        switch (requestCode) {
            case 1:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (position >= 0 &&
                            workReportNewActivity.permission.equals("2") && workReportNewActivity.subordinateTypeCurrentTab == 2) {
