...
public class WorkReportSendMeFragment extends LazyLoadFragment implements HttpListener<String> {
    ...
    private void searchDate(String subtype, String type, String nextId, String keyword, String startTime, String endTime) {
    ...
    public void searchRequest(String keyword, String startTime, String endTime) {
        ...
        nextId = "0";
        Log.e("ceshi", "WorkReportSendMeFragment---抄送我---keyword------" + keyword
                + "------startTime------" + sTime + "/" + startTime
                + "------endTime------" + eTime + "/" + endTime);
        searchDate(subtype + "", type, nextId, keyword, sTime + "", eTime + "");
    }
            ...
            if (RECEIVER_DRAFT.equals(action)) {
                ...
                switch (receiverType) {
                    case PublishTask.PUBLISH_COMMENT:
                        ...
                        if (workReportActivity.permission.equals("1") && workReportActivity.myTypeCurrentTab == 2) {
        ...
        switch (requestCode) {
            case 1:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (position >= 0 &&
                            workReportActivity.permission.equals("1") && workReportActivity.myTypeCurrentTab == 2) {
