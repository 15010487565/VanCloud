...
public class GetCountryNameSort
{
	...
	public static CountrySortModel getCountryModel(String str, List<CountrySortModel> list)
	{
		CountrySortModel sortModel = null;
		for(CountrySortModel model:list)
		{
			String modeName = model.countryNumber.replace("+","");
			if(modeName.equals(str))
			{
				sortModel = model;
				break;
			}
