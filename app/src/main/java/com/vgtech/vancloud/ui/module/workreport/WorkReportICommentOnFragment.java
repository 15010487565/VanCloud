 ...
 */
public class WorkReportICommentOnFragment extends LazyLoadFragment implements HttpListener<String> {
    ...
    public void searchRequest(String keyword, String startTime, String endTime) {
        ...
        nextId = "0";
        Log.e("ceshi", "WorkReportICommentOnFragment---我点评的---keyword------" + keyword
            ...
            if (RECEIVER_DRAFT.equals(action)) {
                ...
                switch (receiverType) {
                    ...
                    case PublishTask.PUBLISH_COMMENT:
                        ...
                        if (workReportActivity.permission.equals("1") && workReportActivity.myTypeCurrentTab == 1) {
        ...
        switch (requestCode) {
            case 1:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (position >= 0 &&
                            workReportActivity.permission.equals("1") && workReportActivity.myTypeCurrentTab == 1) {
