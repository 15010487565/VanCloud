 ...
 * 报表
 */
public class ReportFormWebActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
...
//        mWebView.getSettings().setCacheMode(WebSettings.LOAD_NO_CACHE);
        ...
        mLoadingLayout.setDoLoadAgain(new VancloudLoadingLayout.DoLoadAgain() {
            ...
            public void loadAgain() {
                mWebView.loadUrl(ApiUtils.getHost(ReportFormWebActivity.this) + "appstatic/vantop/report/index.html");
            }
        });
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (!TextUtils.isEmpty(url) && url.endsWith("report/index.html")) {
                mWebView.clearCache(true);
                finish();
            } else {
...
//            mWebView.getSettings().setDomStorageEnabled(true);
            ...
            SharedPreferences preferences = PrfUtils.getSharePreferences(ReportFormWebActivity.this);
            ...
            String token = PrfUtils.getToken(ReportFormWebActivity.this);
            String host = ApiUtils.getHost(ReportFormWebActivity.this) + "v" + ApiUtils.getAppVersion(ReportFormWebActivity.this) + "/";
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            Toast.makeText(ReportFormWebActivity.this, getString(R.string.plans_web_toast), Toast.LENGTH_SHORT).show();
