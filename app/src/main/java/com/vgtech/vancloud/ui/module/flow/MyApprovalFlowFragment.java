 ...
 */
public class MyApprovalFlowFragment extends LazyLoadFragment implements HttpListener<String> {
...
//                    nextId = resutObject.getString("next_id");
            ...
            if (RECEIVER_DRAFT.equals(action)) {
                ...
                switch (receiverType) {
                    ...
                    case PublishTask.PUBLISH_COMMENT:
                        if (flowReportNewActivity.mCurrentTab == 1) {
                ...
                switch (receiverType) {
                    case PublishTask.PUBLISH_FLOW_CONDUCT:
                        ...
                        if (!TextUtil.isEmpty(msg) && flowReportNewActivity.mCurrentTab == 1) {
                            listViewRefreshType = 3;
                            nextId = "0";
                            initDate(type, state + "", nextId);
                            if (showToast)
        ...
        switch (requestCode) {
            case 1:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (position >= 0 && flowReportNewActivity.mCurrentTab == 1) {
    ...
    public void searchRequest(String keyword, String startTime, String endTime) {
        ...
        nextId = "0";
        Log.e("ceshi", "MyApprovalFlowFragment---我审批的流程---keyword------" + keyword
