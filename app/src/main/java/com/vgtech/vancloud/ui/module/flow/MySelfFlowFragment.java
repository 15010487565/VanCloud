 ...
 */
public class MySelfFlowFragment extends LazyLoadFragment implements HttpListener<String> {
            ...
            if (RECEIVER_DRAFT.equals(action)) {
                ...
                switch (receiverType) {
                    ...
                    case PublishTask.PUBLISH_COMMENT:
                        if (flowReportNewActivity.mCurrentTab == 0) {
...
//                        }
        ...
        switch (requestCode) {
            case 1:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (position >= 0 && flowReportNewActivity.mCurrentTab == 0) {
    ...
    public void searchRequest(String keyword, String startTime, String endTime) {
        ...
        nextId = "0";
        Log.e("ceshi", "MySelfFlowFragment---我发起的流程---keyword------" + keyword
