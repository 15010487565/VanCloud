...
public class RcDecoration extends RecyclerView.ItemDecoration{
     ...
     */
    public RcDecoration(int orientation) {
        this(orientation, Color.parseColor("#ececec"), 2);
    }
     ...
     */
    public RcDecoration(int orientation, int color, int divWidth) {
        this.setOrientation(orientation);
        Log.e("TAG_CESHI","color="+color);
    ...
    private void drawTop(Canvas c, View mChild, RecyclerView recyclerView) {
        ...
        c.drawRect(left, top, right, bottom, mPaint);
        Log.e("TAG_CESHI","mPaint="+mPaint.getColor());
    }
