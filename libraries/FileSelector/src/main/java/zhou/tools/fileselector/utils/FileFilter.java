...
public class FileFilter implements Serializable {
    ...
    public static final int FILTER_PDF = 5;
    public static final int FILTER_NOTICE = 6;
    ...
    public static final String[] PDF = new String[]{
            "pdf"
    };
    public static final String[] NOTICE = new String[]{
