...
package com.vgtech.common.ui.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    //private static float MYTEXTSIZE;
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        maskColor = 0x88888888;
        resultColor = 0x88888888;
        resultPointColor = 0xc0ffff00;
        possibleResultPoints = new ArrayList<ResultPoint>(5);
        lastPossibleResultPoints = null;
        //MYTEXTSIZE = 50 * context.getResources().getDisplayMetrics().density / 3;
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0, 0, width, frame.top, paint);//扫描框到屏幕上面的
        canvas.drawRect(0, frame.top, frame.left, frame.bottom + 1, paint);//扫描框左边到屏幕左边的
        canvas.drawRect(frame.right + 1, frame.top, width, frame.bottom + 1, paint);//扫描框右边到屏幕右边的
        canvas.drawRect(0, frame.bottom + 1, width, height, paint);//扫描框下面到屏幕下边的
        ...
        if (resultBitmap != null) {
            ...
            paint.setColor(0x7f00a2e3);//279da7
            ...
            paint.setTextSize(ScreenRate / 1.5f);
            paint.setTextAlign(Paint.Align.CENTER);
            String str = context.getResources().getString(R.string.please_login_qr_code);
            canvas.drawText(str, frame.centerX(), frame.top / 2, paint);
            FontMetrics fm = paint.getFontMetrics();
            int tHeight = (int) Math.ceil(fm.descent - fm.ascent);//文字高度

            paint.setTextSize(ScreenRate / 1.8f);
            canvas.drawText(context.getResources().getString(R.string.frame_below), frame.centerX(), (frame.top / 2) + tHeight * 2, paint);
            //不显示关键点
            ...
            setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, frame.bottom));
        }
    }
